...
test_that("R2 and mll provide the correct values for the null-likelihood", {
  expect_true(mr2(p3, l3)[1] == 0)
  expect_true(mr2(p3, l3)[2] == 0)
  expect_true(mr2(p3, l3)[3] == 0)

  expect_true(mr2(p4, l4)[1] == 0)
  expect_true(mr2(p4, l4)[2] == 0)
  expect_true(mr2(p4, l4)[3] == 0)
})

test_that("R2 and mll handle missing values as intended.", {
  expect_true(mr2(p3miss, l3miss)[1] == 0)
  expect_true(mr2(p3miss, l3miss)[2] == 0)
  expect_true(mr2(p3miss, l3miss)[3] == 0)

  expect_true(is.na(mr2(p3miss, l3miss, na.rm = F)[1]))
  expect_true(is.na(mr2(p3miss, l3miss, na.rm = F)[2]))
  expect_true(is.na(mr2(p3miss, l3miss, na.rm = F)[3]))
})
